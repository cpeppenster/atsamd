...
pub type SPEED_W<'a, const O: u8> = crate::FieldWriter<'a, COMPCTRL_SPEC, 2, O, SPEEDSELECT_A>;
...
pub type INTSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, COMPCTRL_SPEC, 2, O, INTSELSELECT_A>;
...
pub type MUXNEG_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, COMPCTRL_SPEC, 3, O, MUXNEGSELECT_A>;
...
pub type MUXPOS_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, COMPCTRL_SPEC, 2, O, MUXPOSSELECT_A>;
...
pub type HYST_W<'a, const O: u8> = crate::BitWriter<'a, COMPCTRL_SPEC, O>;
