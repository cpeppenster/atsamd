...
pub type INVEN0_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
...
pub type INVEN1_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
...
pub type CPTEN0_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
...
pub type CPTEN1_W<'a, const O: u8> = crate::BitWriter<'a, CTRLC_SPEC, O>;
impl R {
