...
pub type SDAHOLD_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CTRLA_SPEC, 2, O, SDAHOLDSELECT_A>;
...
pub type LOWTOUT_W<'a, const O: u8> = crate::BitWriter<'a, CTRLA_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lowtout(&mut self) -> LOWTOUT_W<30> {
        LOWTOUT_W::new(self)
    }
