...
pub type PMUXE_W<'a, const O: u8> = crate::FieldWriter<'a, PMUX0__SPEC, 4, O, PMUXESELECT_A>;
...
pub type PMUXO_W<'a, const O: u8> = crate::FieldWriter<'a, PMUX0__SPEC, 4, O, PMUXOSELECT_A>;
