...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, CTRL_SPEC, 2, O, MODESELECT_A>;
...
pub type CLKREP_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
#[doc = "Field `MATCHCLR` reader - Clear on Match"]
pub type MATCHCLR_R = crate::BitReader;
#[doc = "Field `MATCHCLR` writer - Clear on Match"]
pub type MATCHCLR_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
...
pub type PRESCALER_W<'a, const O: u8> = crate::FieldWriter<'a, CTRL_SPEC, 4, O, PRESCALERSELECT_A>;
