...
pub type CE_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
#[doc = "Field `ARR` writer - Auxiliary Row Read"]
pub type ARR_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
#[doc = "Field `SMSA` writer - Start Memory Stream Access"]
pub type SMSA_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
impl W {
