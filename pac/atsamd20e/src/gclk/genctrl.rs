...
pub type ID_W<'a, const O: u8> = crate::FieldWriter<'a, GENCTRL_SPEC, 4, O, IDSELECT_A>;
...
pub type SRC_W<'a, const O: u8> = crate::FieldWriter<'a, GENCTRL_SPEC, 5, O, SRCSELECT_A>;
