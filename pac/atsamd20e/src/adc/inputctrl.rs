...
pub type MUXPOS_W<'a, const O: u8> = crate::FieldWriter<'a, INPUTCTRL_SPEC, 5, O, MUXPOSSELECT_A>;
...
pub type INPUTSCAN_W<'a, const O: u8> = crate::FieldWriter<'a, INPUTCTRL_SPEC, 4, O>;
...
pub type INPUTOFFSET_W<'a, const O: u8> = crate::FieldWriter<'a, INPUTCTRL_SPEC, 4, O>;
...
pub type GAIN_W<'a, const O: u8> = crate::FieldWriter<'a, INPUTCTRL_SPEC, 4, O, GAINSELECT_A>;
