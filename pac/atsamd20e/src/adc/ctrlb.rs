...
pub type DIFFMODE_W<'a, const O: u8> = crate::BitWriter<'a, CTRLB_SPEC, O>;
...
pub type FREERUN_W<'a, const O: u8> = crate::BitWriter<'a, CTRLB_SPEC, O>;
...
pub type CORREN_W<'a, const O: u8> = crate::BitWriter<'a, CTRLB_SPEC, O>;
...
pub type RESSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CTRLB_SPEC, 2, O, RESSELSELECT_A>;
...
pub type PRESCALER_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CTRLB_SPEC, 3, O, PRESCALERSELECT_A>;
