...
pub type EVD0_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type EVD1_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type EVD2_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type EVD3_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type EVD4_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type EVD5_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type EVD6_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
...
pub type EVD7_W<'a, const O: u8> = crate::BitWriter<'a, INTFLAG_SPEC, O>;
impl R {
